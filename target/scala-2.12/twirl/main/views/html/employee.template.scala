...
"""),format.raw/*13.1*/("""<table class="table table-bordered table-hover table-condensed">
  ...
  <tbody>
    """),_display_(/*25.6*/for(c<-employees) yield /*25.23*/ {_display_(Seq[Any](format.raw/*25.25*/("""
      """),format.raw/*26.7*/("""<tr>
        ...
        <td>
          <a href=""""),_display_(/*31.21*/routes/*31.27*/.HomeController.updateEmployee(c.getId)),format.raw/*31.66*/("""" class="button-xs btn-danger">
            <span class="glyphicon glyphicon-pencil"></span>
          </a>
        </td>  
        <td>
          <a href=""""),_display_(/*36.21*/routes/*36.27*/.HomeController.deleteEmployee(c.getId)),format.raw/*36.66*/("""" class="button-xs btn-danger"  onclick="return confirmDel()">
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /home/wdd/Documents/Sdev/SDEVCAPlayFramework/lab2/app/views/employee.scala.html
                  HASH: 3f1956c12994b68edd955aa0387991f441be1a8b
