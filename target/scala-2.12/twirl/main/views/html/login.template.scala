...
"""),_display_(/*4.2*/main("Login", user)/*4.21*/ {_display_(Seq[Any](format.raw/*4.23*/("""
    """),format.raw/*5.5*/("""<p class="lead">Project Catalogue</p>
    <div class="col-xs-5">
        <h3>Sign in</h3>
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /home/wdd/Documents/Sdev/SDEVCAPlayFramework/lab2/app/views/login.scala.html
                  HASH: 133129116c40ba6d5d663109950aad3a3b355f97
